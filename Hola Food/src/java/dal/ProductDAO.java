...
public class ProductDAO {
    ...
    public Product getProductById(String id) {
        String sql = "SELECT [ID]\n"
                ...
                + "      ,[image]\n"
                + "      ,[describe]\n"
                + "  FROM [dbo].[ProductHE171956] Where id=?";
    ...
    public void delete(String id) {
        String sql = "Delete from [dbo].[ProductHE171956]\n"
                + "     where ID =? ";
    ...
    public void insert(Product c) {
        String sql = "INSERT INTO [dbo].[ProductHE171956]\n"
                + "           ([name]\n"
                + "           ,[price]\n"
                + "           ,[cid]\n"
                + "           ,[describe]\n"
    ...
    public void update(Product c) {
        String sql = "UPDATE [dbo].[ProductHE171956]\n"
                + "   SET [name] = ?\n"
                + "      ,[price] = ?\n"
                + "      ,[describe] = ?\n"
                + "      ,[image] = ?\n"
    ...
    public List<Product> mostSold() throws SQLException {
        ...
        try {
            String sql = "select top(3) [pid]\n"
                    ...
                    + "      ,[image]\n"
                    + "      ,[describe]\n"
                    + "  FROM OrderLineHE171956 ol join productHE171956 p\n"
                    + "  on ol.pid = p.ID\n"
    ...
    public List<Product> searchPaging(int cid, Integer price, String keyword, String sortby, int index) {
        ...
        if (sortby == null || sortby.equals("") || sortby.equals("feature")) {
            sql = "select p.* from ProductHE171956 p LEFT JOIN OrderLineHE171956 ol ON p.ID = ol.pid\n"
                    + "WHERE 1=1 ";
